...
| **Desktop apps** | **No apps**, **Read windows**, or **Read and act**, Windows only: reading the windows of the apps you add under **Granted apps** in the chat's Details, and at the last level also pressing, filling in and picking in them through UI Automation, in the background. For a step the background cannot do, a chat with one orglet may ask to borrow your real mouse and keyboard for up to 10 seconds, showing the exact steps; touching either stops it. A step that could send, delete, save over a file or close an app asks you every time; a password field is never filled. Off until you turn it on; never in a schedule. See [Desktop apps](desktop.md). |
