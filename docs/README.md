...
| [desktop.md](desktop.md) | Desktop apps on Windows: the apps a chat grants, reading and using their windows through UI Automation, when it asks, borrowing your mouse after asking, what it never does |
