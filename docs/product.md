...
- **Every desktop.** Orglet is for Windows, macOS and Linux. Windows is built and tested first; macOS and Linux builds, packaging and CI come next. Builds are unsigned for now.
