...
Rolling back between two packaged builds with different schema versions has not been tested end to end yet. A partial trial with the v0.2.2 release, and what is still required, is recorded in the [implementation status](implementation_status.md#packaged-rollback-trial-cod-94).
