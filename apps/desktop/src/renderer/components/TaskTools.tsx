...
import { FolderOpen, Globe, ShieldCheck, ShieldOff } from 'lucide-react';
...
export function TaskTools({ grant, networkEnabled, supported, busy, onGrant, onRevoke, onNetworkChange }: {
