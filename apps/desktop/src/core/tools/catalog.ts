...
import { BROWSER_OPEN_TIMEOUT_MS, BROWSER_SNAPSHOT_CHARACTERS, BrowserFindArgs, BrowserOpenArgs, BrowserScrollArgs, BrowserSnapshotArgs, BrowserTabArgs, BrowserTabsArgs, MAX_BROWSER_SCREENSHOTS, MAX_BROWSER_TABS } from '../../shared/browser';
...
export const toolDefinitions: Record<string, ToolDefinition> = {
  ...
  // Orglet's own browser, reading only (COD-261). The core checks each call against the chat's profile and site list.
