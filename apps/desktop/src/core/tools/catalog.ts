...
import {
  DESKTOP_SNAPSHOT_CHARACTERS, DesktopElementArgs, DesktopExpandArgs, DesktopFindArgs, DesktopSetValueArgs, DesktopSnapshotArgs, DesktopWindowArgs, DesktopWindowsArgs,
  MAX_DESKTOP_SCREENSHOTS, MAX_DESKTOP_TEXT_CHARACTERS,
} from '../../shared/desktop';
