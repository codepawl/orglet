...
Orglet is a Windows workspace for reusable AI workers. Give a worker a task and selected text files, then keep its report, evidence references, instructions and run history in one place.
